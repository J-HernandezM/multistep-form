        ...
        <form className='personal'>
          ...
          <div className='inputBox'>
            <div className='personalInputBox'>
              ...
              <input type="text" id='name' name='name' required className='personalInputs' placeholder="e.g. Stephen King"/>
            </div>
            <div className='personalInputBox'>
              <label className='personalLabels' htmlFor="email">Email Address</label>
              <input type="email" id='email' name='email' required className='personalInputs' placeholder="e.g. stephenking@lorem.com"/>
            </div>
            <div className='personalInputBox'>
              <label className='personalLabels' htmlFor="number">Phone Number</label>
              <input type="tel" id='number' name='number' required className='personalInputs' placeholder="e.g. +1 234 567 890"/>
            </div>
          </div>
        </form>
    )
